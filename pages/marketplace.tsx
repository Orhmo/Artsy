...
const Marketplace = () => {
  ...
  const displayedCountText = `See 1-${displayCount} of ${totalArtworks} results`;
  ...
  return (
      <div className='flex flex-col justify-center items-center my-4'>
          <div className='text-center mt-4 px-8 py-2 border rounded-lg shadow-lg mb-8'>{displayedCountText}</div>
      ...
      {displayCount < totalArtworks && (
        <div className='border-2 px-10 py-4 rounded-lg mt-16 cursor-pointer hover:bg-blue-50 hover:text-gray-500 transition-all'>
